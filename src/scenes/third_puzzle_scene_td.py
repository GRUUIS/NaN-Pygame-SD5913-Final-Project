"""Wrapper module: re-export the cleaned ThirdPuzzleScene implementation.

This file intentionally keeps a minimal surface API so other code (or
tests) can import `ThirdPuzzleScene` from the stable path
`src.scenes.third_puzzle_scene_td` while the editable implementation lives
in `third_puzzle_scene_td_clean.py`.
"""

from __future__ import annotations

from .third_puzzle_scene_td_clean import ThirdPuzzleScene
