...
BOSS2_MAX_HEALTH = 680            # Higher durability
...
BOSS2_SLIME_TICK_DAMAGE = 20       # Pool tick damage
BOSS2_SLIME_TICK_INTERVAL = 0.55  # Pool tick interval
...
BOSS2_SLIME_TRAIL_LIFETIME = 13.0  # Segment lifetime
BOSS2_SLIME_TRAIL_DPS = 12.0       # Damage per second baseline
BOSS2_SLIME_TRAIL_IDLE_MULT = 2.4  # Multiplier if player is nearly stationary
BOSS2_SLIME_TRAIL_SLOW = 0.40      # Movement speed multiplier while inside (<1 slows)
